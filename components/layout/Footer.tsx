...
import { ShieldCheck, Lock, HardDrive, Cpu, Heart } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] mt-0.5 leading-relaxed">
                Free tests perform zero database writes. Local history is stored strictly in your browser’s IndexedDB/localStorage.
              </p>
            </div>
          </div>
